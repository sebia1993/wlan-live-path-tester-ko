...
public sealed class InternalProxyRouteDiagnosticRunner
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new InternalProxyRouteDiagnosticRunResult(
            ...
            DirectDirectiveCount: Math.Max(
                0,
                execution.DirectDirectiveCount),
        ...
        plan.Status switch
        {
            ...
            _ =>
                new InternalProxyRouteDiagnosticRunResult(
                    ...
                    SelectionStatus: selection.Status,
                    SourceKind: selection.SourceKind,
                    PlanCode: ProxyDirectiveRouteAnalysisPlanCode
    ...
    private static InternalProxyRouteDiagnosticRunResult CreateTerminal(
    ...
    private static InternalProxyRouteDiagnosticRunResult CreateCanceled(
        ...
        string message) =>
        new(
            Status: InternalProxyRouteDiagnosticRunStatus.Canceled,
            SelectionStatus: selection.Status,
            SourceKind: selection.SourceKind,
            PlanCode: plan.Code,
    ...
    private static InternalProxyRouteDiagnosticRunResult CreateFailed(
        ...
        string message) =>
        new(
            Status: InternalProxyRouteDiagnosticRunStatus.Failed,
            SelectionStatus: selection.Status,
            SourceKind: selection.SourceKind,
            PlanCode: plan.Code,
            InternalRouteStatus: internalStatus,
