...
try {
    ...
    Invoke-CheckedCommand -Description 'Validate central application measurement operation gate' -Command {
        powershell -NoProfile -ExecutionPolicy Bypass -File `
            (Join-Path $root 'scripts\test-application-operation-measurement-gate.ps1')
    }
