...
#pragma warning restore CA2255
    internal static void Run()
    {
        ...
        DefaultSerializationExcludesRawDirectiveAndAnalysis();
        Console.WriteLine(
    ...
    private static void TargetSpecificProxyUsesOnlyTheSelectedHost()
    {
        ...
        Ensure(execution.Analysis?.Status
        ...
        Ensure(execution.Analysis?.DirectFallback == true,
    ...
    private static void ManualMappingsAreFilteredByTheTargetScheme()
    {
        ...
        Ensure(execution.Analysis?.ApplicableEndpointCount == 1
               && execution.Analysis.AnalyzedEndpointCount == 1,
