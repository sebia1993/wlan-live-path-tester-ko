...
왼쪽의 다섯 단계로 진행합니다. 단계 이동만으로 외부 요청을 실행하지 않습니다.

1. **무선 연결 · L1/L2:** 무선 진단 시작을 눌러 Wi-Fi와 AP, 신호·채널·PHY를 확인합니다.
2. **실제 경로 · L3:** Wi-Fi·유선·VPN 동시 연결을 확인하고 필요한 경우 내부·프록시 대상의 OS 경로를 비교합니다.
3. **서비스 연결 · L4~L7:** 프록시 설정과 대상별 경로를 확인합니다. HTTP·인증 결과는 실제 측정 후 해석합니다.
4. **성능 비교:** 승인된 내부·외부 대상을 측정합니다. 반복 측정과 브라우저 관찰은 보조 선택으로 제공합니다.
5. **결과·보고서:** 보고서 생성 후 자료 유무, 근거·의미·한계·다음 점검을 확인합니다.
